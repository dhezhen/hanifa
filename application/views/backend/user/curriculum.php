...
<div class="row justify-content-center">
    <div class="col-xl-12 mb-4 text-center mt-3">
        ...
        <?php if (count($sections) > 0) : ?>
            ...
            <a href="javascript::void(0)" class="btn btn-outline-primary btn-rounded btn-sm ml-1" onclick="showAjaxModal('<?php echo site_url('modal/popup/homework_add/' . $course_id); ?>', '<?php echo get_phrase('Tambah Tugas'); ?>')"><i class="mdi mdi-plus"></i> <?php echo get_phrase('Tambah Tugas'); ?></a>
