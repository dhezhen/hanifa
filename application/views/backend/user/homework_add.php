...
?>
<form action="<?php echo site_url('user/homework/' . $param2 . '/add'); ?>" method="post">
    <div class="form-group">
        <label for="title"><?php echo get_phrase('Judul Tugas'); ?></label>
    ...
    <div class="form-group">
        ...
        <textarea name="summary" id="description" class="form-control"></textarea>
    </div>
